...
check_log "tree && cppcheck --enable=all --inconclusive --error-exitcode=1 -I/HW1/flight_lib -I/HW1 --suppress=missingIncludeSystem /HW1/flight_lib/ /HW1/*.c" "\(information\)"
