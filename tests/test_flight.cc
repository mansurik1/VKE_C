...
TEST(Whole_program, 1) {
  ...
  // the flight code of the flight number 1 -> Please enter the departure
  // airport code of the flight number 1 -> Please enter the arrival airport
  // code of the flight number 1 -> Please enter the duration of the flight
  // number 1 (in minutes) -> Please enter the flight_cost of the flight number
  // 1 (in USD) -> \nPlease enter the flight code of the flight number 2 ->
  // Please enter the departure airport code of the flight number 2 -> Please
  // enter the arrival airport code of the flight number 2 -> Please enter the
  // duration of the flight number 2 (in minutes) -> Please enter the
  // flight_cost of the flight number 2 (in USD) -> \nNow the program will find
  // the least time-consuming air ticket and most advantageous air
  // ticket\naccording to the codes of the airports of departure and arrival you
  // will enter below.\n\nPlease enter the departure airport code -> Please
  // enter the arrival airport code -> \nLeast time-consuming air
  // ticket:\nFlight code: ABC13\nDeparture airport code: SVO\nArrival airport
  // code: VKO\nFlight duration: 75 minutes\nFlight cost: $234.500000\n\nMost
  // advantageous air ticket:\nFlight code: CAB14\nDeparture airport code:
  ...
  int return_code = execute_program(input_file, stdout);

  fclose(input_file);
  // fclose(output_file);

  EXPECT_EQ(return_code, NO_ERROR);
}
