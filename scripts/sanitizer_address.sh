...
check_log "g++ -Wall -g -fsanitize=address,undefined,leak -fno-sanitize-recover=all -fsanitize-undefined-trap-on-error tests/test_flight.cpp -Iflight_lib -lgtest_main -lgtest -lflight_lib -Lbuild/flight_lib -lgcov" "undefined reference"
